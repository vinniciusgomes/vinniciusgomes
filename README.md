...
I currently work as a Senior Mobile Software Engineer at Stone, where I am responsible for developing the mobile application for micro-entrepreneurs using the Ton card machine. As part of my role, I contribute to the success of a company that supports over 5,000 cities across Brazil, reaching 99.7% of the country’s service GDP. Stone is recognized for its top-tier customer service and plays a crucial role in empowering small business owners by handling billions in transactions monthly.
